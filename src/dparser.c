...
SEXP dparserPtr(void) {
  ...
  SEXP ret = PROTECT(allocVector(VECSXP, 110)); pro++;
  ...
  SEXP retN = PROTECT(allocVector(STRSXP, 110)); pro++;
  SET_STRING_ELT(retN, 0, mkChar("dparse___freeP"));
  SET_STRING_ELT(retN, 1, mkChar("dparse_dparse_sexp"));
  SET_STRING_ELT(retN, 2, mkChar("dparse_set_d_file_name"));
  SET_STRING_ELT(retN, 3, mkChar("dparse_get_d_debug_level"));
  SET_STRING_ELT(retN, 4, mkChar("dparse_get_d_verbose_level"));
  SET_STRING_ELT(retN, 5, mkChar("dparse_get_d_use_file_name"));
  SET_STRING_ELT(retN, 6, mkChar("dparse_get_d_rdebug_grammar_level"));
  SET_STRING_ELT(retN, 7, mkChar("dparse_get_d_use_r_headers"));
  SET_STRING_ELT(retN, 8, mkChar("dparse_set_d_debug_level"));
  SET_STRING_ELT(retN, 9, mkChar("dparse_set_d_verbose_level"));
  SET_STRING_ELT(retN, 10, mkChar("dparse_set_d_use_file_name"));
  SET_STRING_ELT(retN, 11, mkChar("dparse_set_d_rdebug_grammar_level"));
  SET_STRING_ELT(retN, 12, mkChar("dparse_set_d_use_r_headers"));
  SET_STRING_ELT(retN, 13, mkChar("dparse_write_binary_tables_to_string"));
  SET_STRING_ELT(retN, 14, mkChar("dparse_write_binary_tables_to_file"));
  SET_STRING_ELT(retN, 15, mkChar("dparse_write_binary_tables"));
  SET_STRING_ELT(retN, 16, mkChar("dparse_write_c_tables"));
  SET_STRING_ELT(retN, 17, mkChar("dparse_escape_string_single_quote"));
  SET_STRING_ELT(retN, 18, mkChar("dparse_escape_string"));
  SET_STRING_ELT(retN, 19, mkChar("dparse_int_list_dup"));
  SET_STRING_ELT(retN, 20, mkChar("dparse_int_list_intersect"));
  SET_STRING_ELT(retN, 21, mkChar("dparse_int_list_diff"));
  SET_STRING_ELT(retN, 22, mkChar("dparse_d_free"));
  SET_STRING_ELT(retN, 23, mkChar("dparse_strhashl"));
  SET_STRING_ELT(retN, 24, mkChar("dparse_dup_str"));
  SET_STRING_ELT(retN, 25, mkChar("dparse_sbuf_read"));
  SET_STRING_ELT(retN, 26, mkChar("dparse_buf_read"));
  SET_STRING_ELT(retN, 27, mkChar("dparse_set_to_vec"));
  SET_STRING_ELT(retN, 28, mkChar("dparse_set_union_fn"));
  SET_STRING_ELT(retN, 29, mkChar("dparse_set_union"));
  SET_STRING_ELT(retN, 30, mkChar("dparse_set_add"));
  SET_STRING_ELT(retN, 31, mkChar("dparse_set_find"));
  SET_STRING_ELT(retN, 32, mkChar("dparse_vec_eq"));
  SET_STRING_ELT(retN, 33, mkChar("dparse_vec_add_internal"));
  SET_STRING_ELT(retN, 34, mkChar("dparse_scan_buffer"));
  SET_STRING_ELT(retN, 35, mkChar("dparse_free_BinaryTables"));
  SET_STRING_ELT(retN, 36, mkChar("dparse_read_binary_tables_from_string"));
  SET_STRING_ELT(retN, 37, mkChar("dparse_read_binary_tables_from_file"));
  SET_STRING_ELT(retN, 38, mkChar("dparse_read_binary_tables"));
  SET_STRING_ELT(retN, 39, mkChar("dparse_ambiguity_count_fn"));
  SET_STRING_ELT(retN, 40, mkChar("dparse_mkdparse_from_string"));
  SET_STRING_ELT(retN, 41, mkChar("dparse_mkdparse"));
  SET_STRING_ELT(retN, 42, mkChar("dparse_free_Action"));
  SET_STRING_ELT(retN, 43, mkChar("dparse_goto_State"));
  SET_STRING_ELT(retN, 44, mkChar("dparse_elem_symbol"));
  SET_STRING_ELT(retN, 45, mkChar("dparse_sort_VecAction"));
  SET_STRING_ELT(retN, 46, mkChar("dparse_build_LR_tables"));
  SET_STRING_ELT(retN, 47, mkChar("dparse_build_scanners"));
  SET_STRING_ELT(retN, 48, mkChar("dparse_state_for_declaration"));
  SET_STRING_ELT(retN, 49, mkChar("dparse_initialize_productions"));
  SET_STRING_ELT(retN, 50, mkChar("dparse_rep_EBNF"));
  SET_STRING_ELT(retN, 51, mkChar("dparse_plus_EBNF"));
  SET_STRING_ELT(retN, 52, mkChar("dparse_star_EBNF"));
  SET_STRING_ELT(retN, 53, mkChar("dparse_conditional_EBNF"));
  SET_STRING_ELT(retN, 54, mkChar("dparse_find_pass"));
  SET_STRING_ELT(retN, 55, mkChar("dparse_add_pass_code"));
  SET_STRING_ELT(retN, 56, mkChar("dparse_add_pass"));
  SET_STRING_ELT(retN, 57, mkChar("dparse_add_declaration"));
  SET_STRING_ELT(retN, 58, mkChar("dparse_dup_elem"));
  SET_STRING_ELT(retN, 59, mkChar("dparse_new_internal_production"));
  SET_STRING_ELT(retN, 60, mkChar("dparse_add_global_code"));
  SET_STRING_ELT(retN, 61, mkChar("dparse_new_code"));
  SET_STRING_ELT(retN, 62, mkChar("dparse_new_token"));
  SET_STRING_ELT(retN, 63, mkChar("dparse_new_ident"));
  SET_STRING_ELT(retN, 64, mkChar("dparse_new_utf8_char"));
  SET_STRING_ELT(retN, 65, mkChar("dparse_new_string"));
  SET_STRING_ELT(retN, 66, mkChar("dparse_new_production"));
  SET_STRING_ELT(retN, 67, mkChar("dparse_new_declaration"));
  SET_STRING_ELT(retN, 68, mkChar("dparse_new_elem_nterm"));
  SET_STRING_ELT(retN, 69, mkChar("dparse_new_rule"));
  SET_STRING_ELT(retN, 70, mkChar("dparse_lookup_production"));
  SET_STRING_ELT(retN, 71, mkChar("dparse_print_term"));
  SET_STRING_ELT(retN, 72, mkChar("dparse_print_rule"));
  SET_STRING_ELT(retN, 73, mkChar("dparse_print_states"));
  SET_STRING_ELT(retN, 74, mkChar("dparse_print_rdebug_grammar"));
  SET_STRING_ELT(retN, 75, mkChar("dparse_print_grammar"));
  SET_STRING_ELT(retN, 76, mkChar("dparse_parse_grammar"));
  SET_STRING_ELT(retN, 77, mkChar("dparse_build_grammar"));
  SET_STRING_ELT(retN, 78, mkChar("dparse_free_D_Grammar"));
  SET_STRING_ELT(retN, 79, mkChar("dparse_new_D_Grammar"));
  SET_STRING_ELT(retN, 80, mkChar("dparse_print_scope"));
  SET_STRING_ELT(retN, 81, mkChar("dparse_next_D_Sym_in_Scope"));
  SET_STRING_ELT(retN, 82, mkChar("dparse_find_D_Sym_in_Scope"));
  SET_STRING_ELT(retN, 83, mkChar("dparse_current_D_Sym"));
  SET_STRING_ELT(retN, 84, mkChar("dparse_update_additional_D_Sym"));
  SET_STRING_ELT(retN, 85, mkChar("dparse_update_D_Sym"));
  SET_STRING_ELT(retN, 86, mkChar("dparse_find_global_D_Sym"));
  SET_STRING_ELT(retN, 87, mkChar("dparse_find_D_Sym"));
  SET_STRING_ELT(retN, 88, mkChar("dparse_new_D_Sym"));
  SET_STRING_ELT(retN, 89, mkChar("dparse_free_D_Scope"));
  SET_STRING_ELT(retN, 90, mkChar("dparse_scope_D_Scope"));
  SET_STRING_ELT(retN, 91, mkChar("dparse_global_D_Scope"));
  SET_STRING_ELT(retN, 92, mkChar("dparse_equiv_D_Scope"));
  SET_STRING_ELT(retN, 93, mkChar("dparse_commit_D_Scope"));
  SET_STRING_ELT(retN, 94, mkChar("dparse_enter_D_Scope"));
  SET_STRING_ELT(retN, 95, mkChar("dparse_new_D_Scope"));
  SET_STRING_ELT(retN, 96, mkChar("dparse_parse_whitespace"));
  SET_STRING_ELT(retN, 97, mkChar("dparse_d_dup_pathname_str"));
  SET_STRING_ELT(retN, 98, mkChar("dparse_resolve_amb_greedy"));
  SET_STRING_ELT(retN, 99, mkChar("dparse_d_pass"));
  SET_STRING_ELT(retN, 100, mkChar("dparse_d_ws_after"));
  SET_STRING_ELT(retN, 101, mkChar("dparse_d_ws_before"));
  SET_STRING_ELT(retN, 102, mkChar("dparse_d_find_in_tree"));
  SET_STRING_ELT(retN, 103, mkChar("dparse_d_get_child"));
  SET_STRING_ELT(retN, 104, mkChar("dparse_d_get_number_of_children"));
  SET_STRING_ELT(retN, 105, mkChar("dparse_free_D_ParseTreeBelow"));
  SET_STRING_ELT(retN, 106, mkChar("dparse_free_D_ParseNode"));
  SET_STRING_ELT(retN, 107, mkChar("dparse_dparse"));
  SET_STRING_ELT(retN, 108, mkChar("dparse_free_D_Parser"));
  SET_STRING_ELT(retN, 109, mkChar("dparse_new_D_Parser"));
