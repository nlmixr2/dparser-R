...
extern "C" {
  ...
  static inline void setDparserPtr0(SEXP p) {
    if (set_d_file_name == NULL) {
      ...
      /* dparse_sexp = (dparse_sexp_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 1))); */
      set_d_file_name = (set_d_file_name_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 2)));
      get_d_debug_level = (get_d_debug_level_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 3)));
      get_d_verbose_level = (get_d_verbose_level_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 4)));
      get_d_use_file_name = (get_d_use_file_name_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 5)));
      get_d_rdebug_grammar_level = (get_d_rdebug_grammar_level_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 6)));
      get_d_use_r_headers = (get_d_use_r_headers_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 7)));
      set_d_debug_level = (set_d_debug_level_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 8)));
      set_d_verbose_level = (set_d_verbose_level_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 9)));
      set_d_use_file_name = (set_d_use_file_name_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 10)));
      set_d_rdebug_grammar_level = (set_d_rdebug_grammar_level_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 11)));
      set_d_use_r_headers = (set_d_use_r_headers_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 12)));
      write_binary_tables_to_string = (write_binary_tables_to_string_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 13)));
      write_binary_tables_to_file = (write_binary_tables_to_file_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 14)));
      write_binary_tables = (write_binary_tables_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 15)));
      write_c_tables = (write_c_tables_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 16)));
      escape_string_single_quote = (escape_string_single_quote_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 17)));
      escape_string = (escape_string_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 18)));
      int_list_dup = (int_list_dup_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 19)));
      int_list_intersect = (int_list_intersect_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 20)));
      int_list_diff = (int_list_diff_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 21)));
      d_free = (d_free_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 22)));
      strhashl = (strhashl_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 23)));
      dup_str = (dup_str_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 24)));
      sbuf_read = (sbuf_read_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 25)));
      buf_read = (buf_read_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 26)));
      set_to_vec = (set_to_vec_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 27)));
      set_union_fn = (set_union_fn_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 28)));
      set_union = (set_union_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 29)));
      set_add = (set_add_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 30)));
      set_find = (set_find_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 31)));
      vec_eq = (vec_eq_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 32)));
      vec_add_internal = (vec_add_internal_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 33)));
      scan_buffer = (scan_buffer_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 34)));
      free_BinaryTables = (free_BinaryTables_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 35)));
      read_binary_tables_from_string = (read_binary_tables_from_string_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 36)));
      read_binary_tables_from_file = (read_binary_tables_from_file_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 37)));
      read_binary_tables = (read_binary_tables_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 38)));
      ambiguity_count_fn = (ambiguity_count_fn_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 39)));
      mkdparse_from_string = (mkdparse_from_string_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 40)));
      mkdparse = (mkdparse_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 41)));
      free_Action = (free_Action_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 42)));
      goto_State = (goto_State_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 43)));
      elem_symbol = (elem_symbol_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 44)));
      sort_VecAction = (sort_VecAction_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 45)));
      build_LR_tables = (build_LR_tables_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 46)));
      build_scanners = (build_scanners_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 47)));
      state_for_declaration = (state_for_declaration_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 48)));
      initialize_productions = (initialize_productions_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 49)));
      rep_EBNF = (rep_EBNF_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 50)));
      plus_EBNF = (plus_EBNF_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 51)));
      star_EBNF = (star_EBNF_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 52)));
      conditional_EBNF = (conditional_EBNF_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 53)));
      find_pass = (find_pass_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 54)));
      add_pass_code = (add_pass_code_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 55)));
      add_pass = (add_pass_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 56)));
      add_declaration = (add_declaration_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 57)));
      dup_elem = (dup_elem_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 58)));
      new_internal_production = (new_internal_production_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 59)));
      add_global_code = (add_global_code_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 60)));
      new_code = (new_code_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 61)));
      new_token = (new_token_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 62)));
      new_ident = (new_ident_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 63)));
      new_utf8_char = (new_utf8_char_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 64)));
      new_string = (new_string_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 65)));
      new_production = (new_production_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 66)));
      new_declaration = (new_declaration_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 67)));
      new_elem_nterm = (new_elem_nterm_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 68)));
      new_rule = (new_rule_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 69)));
      lookup_production = (lookup_production_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 70)));
      print_term = (print_term_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 71)));
      print_rule = (print_rule_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 72)));
      print_states = (print_states_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 73)));
      print_rdebug_grammar = (print_rdebug_grammar_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 74)));
      print_grammar = (print_grammar_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 75)));
      parse_grammar = (parse_grammar_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 76)));
      build_grammar = (build_grammar_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 77)));
      free_D_Grammar = (free_D_Grammar_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 78)));
      new_D_Grammar = (new_D_Grammar_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 79)));
      print_scope = (print_scope_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 80)));
      next_D_Sym_in_Scope = (next_D_Sym_in_Scope_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 81)));
      find_D_Sym_in_Scope = (find_D_Sym_in_Scope_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 82)));
      current_D_Sym = (current_D_Sym_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 83)));
      update_additional_D_Sym = (update_additional_D_Sym_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 84)));
      update_D_Sym = (update_D_Sym_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 85)));
      find_global_D_Sym = (find_global_D_Sym_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 86)));
      find_D_Sym = (find_D_Sym_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 87)));
      new_D_Sym = (new_D_Sym_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 88)));
      free_D_Scope = (free_D_Scope_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 89)));
      scope_D_Scope = (scope_D_Scope_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 90)));
      global_D_Scope = (global_D_Scope_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 91)));
      equiv_D_Scope = (equiv_D_Scope_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 92)));
      commit_D_Scope = (commit_D_Scope_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 93)));
      enter_D_Scope = (enter_D_Scope_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 94)));
      new_D_Scope = (new_D_Scope_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 95)));
      parse_whitespace = (parse_whitespace_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 96)));
      d_dup_pathname_str = (d_dup_pathname_str_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 97)));
      resolve_amb_greedy = (resolve_amb_greedy_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 98)));
      d_pass = (d_pass_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 99)));
      d_ws_after = (d_ws_after_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 100)));
      d_ws_before = (d_ws_before_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 101)));
      d_find_in_tree = (d_find_in_tree_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 102)));
      d_get_child = (d_get_child_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 103)));
      d_get_number_of_children = (d_get_number_of_children_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 104)));
      free_D_ParseTreeBelow = (free_D_ParseTreeBelow_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 105)));
      free_D_ParseNode = (free_D_ParseNode_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 106)));
      dparse = (dparse_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 107)));
      free_D_Parser = (free_D_Parser_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 108)));
      new_D_Parser = (new_D_Parser_type)(R_ExternalPtrAddr(VECTOR_ELT(p, 109)));
    }
  }
